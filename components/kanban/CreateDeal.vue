...
import type { DealFormState } from '@/types/dealForm.types'
...
const { mutate, isPending } = useMutation({
  ...
  mutationFn: (data: DealFormState) => DB.createDocument(DB_ID, COLLECTION_DEALS, uuid(), data),
  onSuccess(data) {
...
const onSubmit = handleSubmit((values: DealFormState) => mutate(values))
</script>
